...
def home(request):
    ...
    # Full catalogue on Home too — paginated, same products as Shop.
    all_page, all_page_range = paginate(request, products)

    return render(request, 'pages/home.html', {
        'new_products': new_products,
        'best_sellers': best_sellers,
        'brands': brands,
        'all_products': all_page,
        'page_range': all_page_range,
    })
