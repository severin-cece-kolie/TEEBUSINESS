...
class StyledSetPasswordForm(SetPasswordForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['new_password1'].widget = forms.PasswordInput(attrs={
            'class': INPUT_CLASS, 'placeholder': _('New password'), 'autocomplete': 'new-password',
        })
        self.fields['new_password2'].widget = forms.PasswordInput(attrs={
            'class': INPUT_CLASS, 'placeholder': _('Confirm new password'), 'autocomplete': 'new-password',
        })
...
class StyledPasswordChangeForm(PasswordChangeForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['old_password'].widget = forms.PasswordInput(attrs={
            'class': INPUT_CLASS, 'placeholder': _('Current password'), 'autocomplete': 'current-password',
        })
        self.fields['new_password1'].widget = forms.PasswordInput(attrs={
            'class': INPUT_CLASS, 'placeholder': _('New password'), 'autocomplete': 'new-password',
        })
