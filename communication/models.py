...
# EmailHistory model removed (2026-06-20): emails are no longer journaled to the
# database. Sending still works via communication.email_backends.LoggingEmailBackend.
